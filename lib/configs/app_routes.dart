...
import 'package:tugas5/modul/news_detail/news_detail.dart';
import 'package:tugas5/modul/splash_screen/splash_screen.dart';
...
class AppRoutes {
  ...
  static Page _homeScreenRoutePageBuilder(
    ...
    if (state.extra != null && state.extra is User) {
      ...
      user = User(
        id: 002,
        name: "Nisrina Khaerunisa",
        userName: "Nisrina",
        email: "2006154@itg.ac.id",
        profileImage:
            "https://cms.dailysocial.id/wp-content/uploads/2022/10/fp7.jpg",
        phoneNumber: "0895358496100",
      );
    }
